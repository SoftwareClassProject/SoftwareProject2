...
public class InventoryManagement {
	...
	public static ArrayList<ArrayList<String>> Read() throws FileNotFoundException{
		...
		Scanner itemsFileScan=new Scanner(new File("C:/Users/rmonroe/Documents/Inventoryfile.txt"));
		String[] itemInfo;
		int i=0;
	...
	public static void Write(ArrayList<ArrayList<String>> items) throws IOException{
		BufferedWriter buff=new BufferedWriter(new FileWriter("C:/Users/rmonroe/Documents/Inventoryfile.txt"));
	...
	public static ArrayList<ArrayList<String>> InventoryManagementChoices() throws IOException{
		...
		loop: while(exitnum!=5){
	        ...
	        case(2):
		    	...
		    	String aSkuNum=Integer.toString(inventory.size());
