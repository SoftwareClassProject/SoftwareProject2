 ...
 * Three classes were made in order to complete the progra - Main, UserManagement, and InventoryManagement.
...
public class Main {
	...
	public static void ReportWrite(ArrayList<ArrayList<String>> activities) throws IOException{
		BufferedWriter buff=new BufferedWriter(new FileWriter("C:/Users/rmonroe/Documents/Reportfile.txt"));
	...
	public static ArrayList<ArrayList<String>> ReportRead() throws FileNotFoundException{
		...
		Scanner reportFileScan=new Scanner(new File("C:/Users/rmonroe/Documents/Reportfile.txt"));
		String[] information;
		int i=0;
	...
	public static ArrayList<ArrayList<String>> UserRead() throws FileNotFoundException{
		...
		//Scanner that reads the data from the specified file
		Scanner userFileScan=new Scanner(new File("C:/Users/rmonroe/Documents/Userfile.txt"));
		String[] credentials;
		int i=0;
	...
	public static  void GenerateReport(ArrayList<ArrayList<String>> activity) throws FileNotFoundException{
		...
		for(int i=0; i<activity.size(); i++){
			if(date.equals(activity.get(i).get(0))){
	...
	//This method authenticated the credentials inputted by the user to log onto the system. 
	public static ArrayList<ArrayList<String>> Authentication() throws IOException, NoSuchAlgorithmException {
		...
		for(int l=0; l<users.size(); l++){
			if(users.get(l).get(0).equals(username) && users.get(l).get(1).equals(Encryption(password))){
